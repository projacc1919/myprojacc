...
public class WhUserTypeUtil {
	...
	public void generatePie(String path,List<Object[]> data) {
		...
		JFreeChart chart=ChartFactory.createPieChart3D("WH User ID Type", dataset, true, true, false);
	...
	public void generateBar(String path,List<Object[]> data) {
		...
		JFreeChart chart=ChartFactory.createBarChart("WH User ID Type","ID Type", "COUNT", dataset);
